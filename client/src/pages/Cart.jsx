  ...
  if (cartData.length === 0) {
    return (
      <div className='flex flex-col items-center justify-center py-20 text-gray-500'>
        ...
        <p className='text-sm mb-6'>Looks like you have not added anything to your cart yet.</p>
        <button
          onClick={() => navigate('/')}
          ...
          return (
            ...
            >
              ...
              <div className='flex flex-col sm:flex-row sm:ml-3 items-center justify-center border border-gray-300 rounded-md max-w-16 sm:max-w-24 px-2 py-1 bg-white shadow-sm'>
                ...
                />
                <p className='text-center mx-0 sm:mx-3 text-sm sm:text-base font-medium min-w-6 my-1 sm:my-0'>
                  {item.quantity}
                </p>
                <img
